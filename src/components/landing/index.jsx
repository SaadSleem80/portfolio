            ...
            <div className='relative h-full'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10 h-full z-10'>
                    <div className='flex flex-col gap-7 my-auto'>
                        <div>
                            <h1 className='text-3xl md:text-5xl font-bold'>Hello, I'm <span className='text-green-500'>Saad Sleem</span></h1>
                            <p className='text-gray-400 text-md md:text-xl mt-4'>Full Stack Developer</p>
                        </div>
                        <div className='flex flex-col gap-4'>
                            <p className='text-gray-400 text-foreground text-md md:text-xl'>I build robust and scalable web applications using Laravel, React, Vue.js, and various other modern technologies. With expertise in both frontend and backend development, I create seamless digital experiences that solve real-world problems.</p>
